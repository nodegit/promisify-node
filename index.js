...
if(exports.toString().startsWith('class')) {
 var proto = Object.create(exports.prototype)
 proto.constructor = !1;
 proto = processExports(proto, test, cached, name);
 proto.constructor = exports.prototype.constructor;
